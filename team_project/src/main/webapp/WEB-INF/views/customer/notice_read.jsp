		...
		<div class="row">
			...
			<div class="col-md-8">
				<div class="row">
					...
					<div class="col-md-9">
						<form role="form" method="post" action="/customer/notice_modify">
						<input type="hidden" value="${loginVo.userid}" name="userid">
						<span id="notice_top">공지사항</span>
						<button type="submit" class="btn btn-outline-danger" 
							id="notice_modify" style="display:none;">공지사항 수정</button>
						<hr>
							<div class="form-group notice-form">
								<b>제목</b><b>   작성자 : ${noticeVo.username}</b>
								<input type="text" class="form-control" id="n_title" 
									name="n_title" value="${noticeVo.n_title}" readonly/>
							</div>
							<div class="form-group notice-form">
								<b>내용</b>
								<textarea class="form-control" id="n_content" 
									name="n_content" rows="20" readonly>${noticeVo.n_content}</textarea>
							</div>
